          ...
          <div className="inner">
            <div className="col-1">
              ...
              <ul className="ftrmenu">
                ...
                <li>
                  <a href="#" onClick={handleClick}>Get a Qoute </a>
                </li>
              </ul>
            </div>
            <div className="col-2">
              ...
              <ul className="ftrmenu">
                ...
                <li><Link to="/responsive-uiux">Responsive UI/UX</Link></li>
                <li><Link to="/qa-testing-security">QA Testing/Security</Link></li>
                <li><Link to="/health-care-consultation">Health Care Consultation</Link></li>
