...
function Navbar() {
  ...
  return (
    ...
    <div className="mobileMenubar">
      <a href="index.php" aria-label="Read more"><img src="img/logo.png" alt="" className="logo"/></a>
      ...
      <nav className={`mobilemenu ${menuOpen ? "open" : ""}`}>
        ...
        <ul className="m-nav">
          ...
          <li><a href="#" onClick={() => setMenuOpen(false)}>Career</a></li>
          <li><a href="/hire-developers" onClick={() => setMenuOpen(false)}>Hire Developers</a></li>
          <li><a href="/contact-us" className="contactBtn" onClick={() => setMenuOpen(false)}>Contact Us</a></li>
        </ul>
      </nav>
    </div>
                    ...
                    <li>
                      ...
                      <div className="dropdown" ref={dropdownRef}>
                        ...
                        <div className={`dropdown-content ${open ? "show" : ""}`}>
                          ...
                          <a href="#">Responsive UI/UX</a>
                          <a href="#">QA Testing/Security</a>
                          <a href="#">Health Care Consultation</a>
